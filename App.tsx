            ...
            <Btn
              ...
              onPress={() => {
                if (update) {
                  ...
                  // updateTodo[updateIndex] = input;
                  // setTodo(updateTodo);
                  // setTodo(prev=>[...prev ,prev[updateIndex]=input])
                  setTodo(prev =>
                    prev.map((x, i) => (i == updateIndex ? input : x)),
                  );
                  // ignor this
                  // setTodo(prev => [
                  //   (prev[updateIndex] = input),
                  ...
                  if (input === '') return Alert.alert('Enter Value');
